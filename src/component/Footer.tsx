    ...
    <div className="footerP clip-contents">
      <div className="logoM">
        <div className="unimet">
          ...
          <img
            src= {logoUnimet} alt="LogoUnimet"
            className="logoUnimet"
          />
        </div>
        <img
          src= {logoM} alt="LogoMolokai"
          className="LogoMolokai"
